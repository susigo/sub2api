...
const (
	...
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 Token自助站部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the Token Self-Service Station Deployment and Operation Compliance Commitment"
